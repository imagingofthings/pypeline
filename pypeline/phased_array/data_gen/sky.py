...
def is_source_config(x):
    ...
    :py:class:`~pypeline.phased_array.data_gen.sky.SkyEmission` config specification.
...
class SkyEmission:
    ...
    .. testsetup::
       ...
       import astropy.units as u
       import numpy as np
       from pypeline.phased_array.data_gen.sky import SkyEmission
    ...
    def __init__(self, source_config):
        ...
        source_config
            ...
            Must satisfy :py:func:`~pypeline.phased_array.data_gen.sky.is_source_config`.
        """
...
def from_tgss_catalog(direction, FoV, N_src):
    """
    Generate :py:class:`~pypeline.phased_array.data_gen.sky.SkyEmission` from the
    ...
    Returns
    -------
    :py:class:`~pypeline.phased_array.data_gen.sky.SkyEmission`
        Sky model.
    """
    if FoV <= 0:
