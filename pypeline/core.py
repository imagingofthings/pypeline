...
Pypeline is structured around the concept of :py:class:`~pypeline.core.Block`: callable objects that
...
class Block(abc.ABC):
    ...
    :py:meth:`~pypeline.core.Block.__call__`.  This function is assumed to be useable directly after
