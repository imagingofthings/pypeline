...
namespace bluebild {
    ...
    template <typename T>
    auto standard_synthesizer(ContextInternal& ctx,
                              const T* d,
        ...
        if(ctx.processing_unit() == BLUEBILD_PU_GPU) {
            ...
            standard_synthesizer_host<T>(ctx, d, v, xyz, w, c_idx, Nl, grid, wl,
                                         Na, Nb, Nc, Ne, Nh, Nw,
    ...
    extern "C" {
        ...
        BLUEBILD_EXPORT BluebildError bluebild_standard_synthesizer_s(BluebildContext ctx,
            ...
            try {
                standard_synthesizer<float>(*InternalContextAccessor::get(*reinterpret_cast<Context *>(ctx)),
                                            d, 
        ...
        BLUEBILD_EXPORT BluebildError bluebild_standard_synthesizer_d(BluebildContext ctx,
            ...
            try {
                standard_synthesizer<double>(*InternalContextAccessor::get(*reinterpret_cast<Context *>(ctx)),
                                             d,
